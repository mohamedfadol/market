...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo e(asset('web/assets/css/animate.css')); ?>">
...
<body class="home-page home-01 ">
	...
	<!--header-->
  <?php echo $__env->make('layouts.web.webHeader', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
  ...
  <?php echo $__env->make('layouts.web.webFooter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
	...
	<script src="<?php echo e(asset('web/assets/js/jquery.flexslider.js')); ?>"></script>
	<script src="<?php echo e(asset('web/assets/js/chosen.jquery.min.js')); ?>"></script>
	<script src="<?php echo e(asset('web/assets/js/owl.carousel.min.js')); ?>"></script>

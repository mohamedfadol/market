				...
				<ul class="products-cart">
					<li class="pr-cart-item">
						<div class="product-image">
							<figure><img src="{{ asset('/web/assets/images/products/digital_18.jpg') }}" alt=""></figure>
						</div>
					...
					<li class="pr-cart-item">
						<div class="product-image">
							<figure><img src="{{ asset('/web/assets/images/products/digital_20.jpg') }}" alt=""></figure>
						</div>
						<div class="product-name">
							<a class="link-to-product" href="#">Radiant-360 R6 Wireless Omnidirectional Speaker [White]</a>
						</div>
						...
						<div class="product product-style-2 equal-elem ">
							<div class="product-thumnail">
								<a href="#" title="T-Shirt Raw Hem Organic Boro Constrast Denim">
									<figure><img src="{{ URL::asset('/storage/product/image/'.$product->image) }}" width="214" height="214" alt="T-Shirt Raw Hem Organic Boro Constrast Denim"></figure>
								</a>
							...
							<div class="product-info">
								...
								<div class="wrap-price"><ins><p class="product-price">{{ number_format($product->regural_price ,2) }}</p></ins> <del><p class="product-price">{{ number_format($product->sale_price ,2) }}</p></del></div>
							</div>
						</div>
						@endforeach  
					</div>

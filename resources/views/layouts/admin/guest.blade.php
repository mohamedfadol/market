...
<div class="wrapper">
    ...
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" data-widget="pushmenu" href="#" role="button">
            <img src="{{ asset('/template/dist/img/logo.png')}}" alt="User Avatar" style="margin-top: -15px; margin-left: -158px;">
        </a>
      </li>
      <!--<li class="nav-item d-none d-sm-inline-block">-->
      <!--  <a href="index3.html" class="nav-link">Generals</a>-->
      <!--</li>-->
      <!--<li class="nav-item d-none d-sm-inline-block">-->
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2020-2021 <a href="https://Aurages.Com">Aurages CO LTD</a>.</strong>
    All rights reserved.
    <div class="float-right d-none d-sm-inline-block">
      <b>Version</b> 3.1.1.21
    </div>
  </footer>
